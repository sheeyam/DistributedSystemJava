...
class ShellvacumarP1MidServerV2 implements Runnable {
	...
	// Constructor
	public ShellvacumarP1MidServerV2(Socket s) {
		try {
	...
	public void run() {
		try {
			...
			String[] uparr = clientUserPass.split(" ");
			System.out.println("Username: " + uparr[0]);
			System.out.println("Password: " + uparr[1]);

			String responseToClient; // Response sent to client.
            ...
            String allListGroupName = Constants.NOTHING + " " + groupName;
			...
			String itemQuantityPoints = itemQuantity + " " + points + " " + groupName; // pendrive 1 1200 silver
	...
	public static void main(String[] args) throws Exception {
		System.out.println("Threaded TCP Mid Server V2 is Running  ");
		...
		while (true) {
			...
			ShellvacumarP1MidServerV2 server = new ShellvacumarP1MidServerV2(sock);
